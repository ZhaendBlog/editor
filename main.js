$(document).ready(function(){if(window.location.hostname==zhaendblog){canvas=new fabric.Canvas('canvas');canvas.renderAll.bind(canvas);var demoanhurl=$(".demoanhurl").hide();var b1=$(".b1");var b2=$(".b2").hide();var b02=$(".b02").hide();var b3=$(".b3").hide();var b13=$(".b13");var b23=$(".b23").hide();var b4=$(".b4").hide();canvas.selection=false;var fonts=["Roboto","VT323","Pacifico","Amatic SC","Lobster","Crimson Pro","Tangerine"];fabric.Object.prototype.customiseCornerIcons({settings:{borderColor:'white',cornerSize:10,cornerShape:'circle',cornerBackgroundColor:'white',cornerPadding:20}});var blendmode=[{mode:"source-over",name:"Normal"},{mode:"screen",name:"Filtrado"},{mode:"multiply",name:"Multiplicado"},{mode:"overlay",name:"Sobrexpuesto"},]
...
window.location.hash=inputurl;$("#tad-urlimg").html("<img  src='"+inputurl+"' class='img-thumbnail w-100' id='imgurl' alt='Zhaend.Net'/>");cvs=document.createElement("canvas");ctx=cvs.getContext('2d');var img=new Image();img.onload=function(){cvs.width=this.width;cvs.height=this.height;tyle=cvs.height/cvs.width
...
$("#backb1").click(function(){$('#dongtad').modal('show');});$('#dongtad .co').click(function(){canvas.clear();dongbang();});$('#dongtad .khong').click(function(){dongbang();});$("#backb2").click(function(){b2.show();b3.hide();});var tenanh="Zhaend blog";var dinhdang="jpg";var kichco=2;$(".dinhdang input").click(function(){dinhdang=$("input:checked").val()});$(".kichco").change(function(){kichco=$(this).val()});$(".tenanh").on("input",function(){tenanh=$(".tenanh").val()});$("#tad-luuanh").click(function(){canvas.deactivateAll();var a=canvas.width;var b=canvas.height;canvas.setZoom(kichco);canvas.setDimensions({width:a*kichco,height:b*kichco});canvas.renderAll();$("#canvas").get(0).toBlob(function(c){saveAs(c,tenanh+".png")});canvas.setZoom(1);canvas.setDimensions({width:a,height:b})});}});
